 ...
 * URL重写技术Demo 主要是通过用户点击不用的URL 执行不同的逻辑 是一种会话跟踪技术
 */
...
public class Top10Servlet extends HttpServlet {
	...
	private void showMainPage(HttpServletRequest request,
		...
		writer.print("<html><head>"
				+ "<title>Top 10 Tourist Attractions</title>" + "</head><body>"
	...
	private void showAttractions(HttpServletRequest request,
			HttpServletResponse response, String city) throws IOException {
		// TODO Auto-generated method stub
		int page = 1;
		...
		writer.print("<hr style='color:red'/>" + "<a href='?city=" + city
				+ "&page=1'>Page 1</a>");
